...
![GitHub Tag](https://img.shields.io/github/v/tag/cosmo-local-credit/eth-indexer)

A lightweight Postgres chain indexer designed to couple with
[eth-tracker](https://github.com/cosmo-local-credit/eth-tracker) to index all
...
```bash
git clone https://github.com/cosmo-local-credit/eth-indexer.git
cd eth-indexer
